...
func (s *SQLiteStorage) CreateProvider(provider *api.ProviderResource) error {
...
func (s *SQLiteStorage) GetProvider(id string) (*api.ProviderResource, error) {
	return s.getUserProviderTransactional(nil, id)
}

func (s *SQLiteStorage) getUserProviderTransactional(txn *db.Tx, id string) (*api.ProviderResource, error) {
