...
// #######################################################################
func (s *SQLiteStorage) CreateEvaluationJob(evaluation *api.EvaluationJobResource) error {
...
func (s *SQLiteStorage) GetEvaluationJob(id string) (*api.EvaluationJobResource, error) {
	e := sql.SQLExecutor{
		Db:  s.pool,
		Ctx: s.ctx,
	}
...
func (s *SQLiteStorage) GetEvaluationJobs(filter abstractions.QueryFilter) (*abstractions.QueryResults[api.EvaluationJobResource], error) {
...
func (s *SQLiteStorage) DeleteEvaluationJob(id string) error {
...
func (s *SQLiteStorage) UpdateEvaluationJobStatus(id string, state api.OverallState, message *api.MessageInfo) error {
	...
	err := sql.WithTransaction(s.pool, s.ctx, s.logger, "update evaluation job status", id, func(txn *db.Tx) error {
		...
		if err := s.updateEvaluationJobStatusTxn(txn, evaluationJob, state, message); err != nil {
			return err
		}
...
func (s *SQLiteStorage) updateEvaluationJobStatusTxn(txn *db.Tx, evaluationJob *api.EvaluationJobResource, overallState api.OverallState, message *api.MessageInfo) error {
...
func (s *SQLiteStorage) UpdateEvaluationJob(id string, runStatus *api.StatusEvent) error {
