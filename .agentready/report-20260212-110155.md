...
**Repository**: eval-hub
**Path**: `/Users/ddahlem/Documents/repos/trusty/eval-hub/eval-hub`
**Branch**: `main` | **Commit**: `a098f586`
...
**Evidence**:
- CI config found: .github/workflows/security.yml, .github/workflows/publish-python-server.yml, .github/workflows/tests.yml, .github/workflows/agentready-assessment.yml, .github/workflows/ci.yml
...
- **Repository Snapshot**: a098f5860c2c26b67671ac5648ee6f74930671cf
- **Assessment Duration**: 0.3s
